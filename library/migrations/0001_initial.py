# Generated by Django 3.0.4 on 2020-05-02 16:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='library.Listing')),
            ],
        ),
        migrations.AddField(
            model_name='user',
            name='loan',
            field=models.ManyToManyField(related_name='loans', to='library.Listing'),
        ),
        migrations.AddField(
            model_name='user',
